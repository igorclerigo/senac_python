...
desejo = input("Você deseja ver os quatro últimos lançamentos? (S/N)").lower()
if desejo == "sim":
    print(lista_atletas2)

print(f"Os dez primeiros lançamentos foram: {lista_atletas}")
print(f"Os sete lançamentos subsequentes: {lista_atletas1}")